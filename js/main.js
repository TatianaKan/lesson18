...
//     let arr = str.
//         replace(reg, ' ').//ищет значение и заменяет на 2 параметр
//         toLowerCase().
//         split(' '). //возвращает новый массив
//         filter((element) => element.inexOf(subStr) > -1); //индекс первого элемента >0
//     let rez = new Set(); //set содержит множество уникальных значений

//     arr.forEach(element => {//перебираем массив
//         rez.add(element); //добавляем элемент
//     });
//     return rez;
// };
let wordsList = (str, subStr) => {
...
console.log('1'); console.log(car.info()); // chevrolet Lacetti, 2000cc, year 2010, used
car.used = 'new';
console.log('2'); console.log(car.info()); // chevrolet Lacetti, 2000cc, year 2019, new -- год изменен
car.used = 'used';
console.log('3'); console.log(car.info()); // chevrolet Lacetti, 2000cc, year 2019, new -- изменения не выполняются
console.log('car2'); console.log(car2.info()); // infinite FX50 AWD, 5000cc, year 2019, new
car2.used = 'used';
console.log('car 2  1'); console.log(car2.info()); // infinite FX50 AWD, 5000cc, year 2019, new -- изменения не выполняются
